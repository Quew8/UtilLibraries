...
import com.quew8.glslparser.GLSLEffectParser.EffectCode;
import com.quew8.glslparser.GLSLEffectParser.GLSLEffect;
...
public class GLSLPipelineParser extends GLSLParser<GLSLPipelineParser> {
    ...
    public HashMap<String, XMLElementParser> addElementParsers(HashMap<String, XMLElementParser> to) {
        ...
        to.put(EFFECT, (XMLElementParser) (Element element) -> {
