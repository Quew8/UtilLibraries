...
public class DesktopLoadedImage implements LoadedImage {
    ...
    /*protected static ByteBuffer convertAlphaMaskImageData(BufferedImage bufferedImage, 
            boolean flipped) {
        
        return TextureUtils.convertAlphaMaskImageData(
                bufferedImage, 
    ...
    protected static ByteBuffer convertAlphaMaskImageData(DesktopLoadedImage img, 
        ...
        return TextureUtils.convertImageData(
                img, 
                texWidth, 
                texHeight, 
                flipped, 
                GLTexFormat.DEPTH.getNComponents(), 
                GLTexFormat.DEPTH.getColorModel()
                );
    }*/
