 ...
 * @author Quew8
 */
public class LessThanFunction<T, S> extends ComparatorFunction<T, S> {
    
    public LessThanFunction(Comparator<T> comparator, Function<T, S> function1, Function<T, S> function2) {
