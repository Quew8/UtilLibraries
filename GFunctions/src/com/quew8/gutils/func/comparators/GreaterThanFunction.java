 ...
 * @author Quew8
 */
public class GreaterThanFunction<T, S> extends ComparatorFunction<T, S> {
    
    public GreaterThanFunction(Comparator<T> comparator, Function<T, S> function1, Function<T, S> function2) {
