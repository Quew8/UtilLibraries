 ...
 * @author Quew8
 */
public class FloatAddFunction<S> extends AbstractDualOperandFunction<Float, Float, S> {
    
    public FloatAddFunction(Function<Float, S> function1, Function<Float, S> function2) {
