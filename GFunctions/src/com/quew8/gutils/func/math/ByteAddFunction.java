 ...
 * @author Quew8
 */
public class ByteAddFunction<S> extends AbstractDualOperandFunction<Byte, Byte, S> {
    
    public ByteAddFunction(Function<Byte, S> function1, Function<Byte, S> function2) {
