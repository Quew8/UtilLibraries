...
import com.quew8.geng.collada.ColladaSkeleton;
import com.quew8.geng.collada.DataFactory;
import com.quew8.geng.collada.InstanceController;
...
class InstanceControllerParser extends XMLParser {
    ...
    public <T> InstanceController<T> getInstanceController(DataFactory<?, ?, ?, T> factory, TextureArea texture) {
